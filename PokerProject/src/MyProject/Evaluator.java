...
public class Evaluator {
	...
	//improvments just sort a 2d array holding evals for all hands
		public ArrayList<Integer> getStrongestHand(ArrayList<ArrayList<Integer>> fiveCardHands) {
		...
		public int evaluate(ArrayList<Integer> fiveCards) {
			...
			Integer c4 = fiveCards.get(3);
			Integer c5 = fiveCards.get(4);
			...
			//other pairs
			ans = (c1 & 0xFF) * (c2 & 0xFF) * (c3 & 0xFF) * (c4 & 0xFF) * (c5 & 0xFF);
		...
		//binary search to find prime products
